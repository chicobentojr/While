...
comando: ID ':=' expressao                          # atribuicao
       ...
       | '{' seqComando '}'                         # bloco
       | 'para' ID 'de' expressao 'ate' expressao 'passo' expressao 'faca' seqComando 'fimpara'   #laco
       | 'escolha' ID ('caso' expressao ':' seqComando)+ 'outro : ' seqComando 'fimescolha'  #escolha
       ;
